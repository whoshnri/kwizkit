  ...
  return (
    <div className="theme-bg flex items-center justify-center min-h-screen">
      <div className="w-full theme-border text-center space-y-1">
        ...
        <Link
          href="/"
          className="inline-block theme-bg border theme-border theme-text px-6 py-2.5 rounded-md text-sm font-medium transition-colors active:scale-95 focus:outline-none"
        >
          Go Home
        </Link>
      </div>
