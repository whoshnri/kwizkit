...
const HeroSection = () => (
  <section className="text-center py-8 max-w-4xl mx-auto ">
    ...
    <p className="max-w-3xl mx-auto text-lg sm:text-xl theme-text-secondary mb-8">
      Effortlessly create, grade, and analyze tests with the power of AI. Save
      time, reduce bias, and gain deeper insights into student performance.
    </p>
    <Link href={"/auth/"}>
    ...
    <div className="bg-transparent border-2 border-dashed theme-border-color rounded-md p-4 shadow-lg">
      ...
      <div className="w-full aspect-video theme-bg-subtle rounded-sm flex items-center justify-center">
        <p className="theme-text-secondary text-sm">
          [Dashboard Video/Screenshot Placeholder]
        </p>
      </div>
    </div>
  </section>
  ...
  const features = [
    {
      ...
      description:
        "Generate diverse and relevant questions from your source material in seconds.",
    },
    {
      icon: <FaMagic />,
      title: "Automated Grading",
      description:
        "Save countless hours with instant, accurate, and unbiased automated grading.",
    },
    {
      icon: <FaChartLine />,
      title: "In-Depth Analytics",
      description:
        "Track student performance and identify knowledge gaps with powerful insights.",
    },
    {
      icon: <FaCertificate />,
      title: "Custom Certifications",
      description:
        "Automatically issue secure, verifiable certificates upon course completion.",
    },
    {
      icon: <FaShieldAlt />,
      title: "High Security",
      description:
        "Ensure the integrity of your assessments with robust, secure protocols.",
    },
    {
      icon: <FaQuestionCircle />,
      title: "Variety of Question Types",
      description:
        "From multiple-choice to long-form essays, our AI handles it all.",
    },
  ];
    ...
    <section className="py-16 sm:py-20">
      <div className="text-center mb-12">
        ...
        <p className="max-w-2xl mx-auto mt-4 text-lg theme-text-secondary">
          Everything you need to create and manage assessments, all in one
          platform.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {features.map((feature, index) => (
          <div
            key={index}
            className="p-6 border-2 border-dashed theme-border-color"
          >
            <div className="text-3xl theme-text-accent mb-4">
              {feature.icon}
            </div>
...
const FinalCTA = () => (
  <section className="py-16 sm:py-24 text-center border-2 border-dashed theme-border-color rounded">
    ...
    <p className="max-w-2xl mx-auto text-lg theme-text-secondary mb-8">
      Join hundreds of educators who are already saving time and enhancing their
      teaching.
    </p>
    <Link href={"/auth/"}>
      <span className="theme-button inline-block text-center text-base font-semibold">
